...
>
    ...
    <body class="h-full">
        <div class="min-h-full">
            <nav class="bg-gray-800">
                <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div class="flex h-16 items-center justify-between">
                        ...
                        <div class="hidden md:block">
                            <div class="ml-4 flex items-center md:ml-6">
                                ...
                                <div class="relative ml-3">
                                    ...
                                    <div
                                        id="modal_test"
                                        class="focus:outline-hidden absolute -left-20 z-10 mt-2 hidden w-48 origin-top-left rounded-md border border-indigo-700 bg-white shadow-lg"
                        ...
                        {{-- <svg class="size-6" stroke-width="1.5" --}}
            ...
            <main data-id="mainview" class="h-screen">
                <div class="mx-auto h-full max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
                    {{ $slot }}
                </div>
            </main>
